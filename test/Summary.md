...
| Replay | TC_Replay_001_direct_can_replay_blf | OK | |
| Replay | TC_Replay_002_direct_channel_mapping | OK | |
| Replay | TC_Replay_003_direct_channel_and_id_filter | OK | |
| Replay | TC_Replay_004_direct_speed_control | OK | |
| Replay | TC_Replay_005_direct_loop_mode | OK | |
| Replay | TC_Replay_006_direct_rejects_pcap | OK | |
| Replay | TC_Replay_007_direct_pcapng_can_extraction | OK | |
| Replay | TC_Replay_008_import_blf_frame_count | OK | |
| Replay | TC_Replay_009_server_side_can_stream | OK | |
| Replay | TC_Replay_010_pause_resume_seek_stop | OK | |
| Replay | TC_Replay_011_repeat_without_reimport | OK | |
| Replay | TC_Replay_012_eth_pcap_import_global_ip_rewrite | OK | |
| Replay | TC_Replay_013_eth_ip_map_and_filter | OK | |
| Replay | TC_Replay_014_eth_ethertype_protocol_port_filters | OK | |
| Replay | TC_Replay_015_eth_ipv6_and_icmpv6 | OK | |
| Replay | TC_Replay_016_eth_mac_map_playback_time | OK | |
| Replay | TC_Replay_017_import_mixed_pcapng | OK | |
| Replay | TC_Replay_018_export_trace_to_pcapng | OK | |
| Replay | TC_Replay_019_export_skips_tcp_pdu | NOK | tcp frames not recognized by import, therefore not skipped |
