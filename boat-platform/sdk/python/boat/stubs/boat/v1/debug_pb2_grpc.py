...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in boat/v1/debug_pb2_grpc.py depends on'
...
def add_DebugServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'boat.v1.DebugService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('boat.v1.DebugService', rpc_method_handlers)
